...
> Versione stabile 0.4.13 con pulsante per fermare immediatamente lo spot e ripristinare la musica, streaming MP3 compatibile con le richieste parziali Sonos, spot sincronizzati esclusivamente sui Sonos selezionati, interfaccia adattata a telefoni e tablet, browser completo della libreria Sonos senza URL, accesso dalla barra laterale anche per utenti non amministratori, durata automatica degli spot, sequenze/collage 16:9 e canali IPTV HLS indipendenti.

Nel repository è disponibile anche **Carellas Media Ads Beta 0.5.0-beta.2** come applicazione separata sulla porta `8100`. La stabile 0.4.13 rimane Sonos-only e include arresto manuale dello spot, spot sincronizzati soltanto sui diffusori scelti, streaming MP3 con richieste parziali, un'interfaccia responsive, lo stesso browser musicale visibile nel player Sonos di Home Assistant, durata automatica degli spot, sequenze IPTV ordinabili, video completi, adattamento 16:9, collage ed effetti. La Beta mantiene anche Alexa.
